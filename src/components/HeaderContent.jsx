      ...
      <HeaderContentStyled>
         <div className="left-content">
            <div className="left-text-container">
               <h1 data-aos='zoom-in-right'>ALgunos componentes</h1>
               <p className="white">
                  Tienen realidad aumentada con AR.js, en el codigo busca los que tienen scene
               </p>
               <SecondaryButton name='Revisa el codigo' />
            </div>
         </div>
